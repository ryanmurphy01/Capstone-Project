...
//Admin routes Group
Route::group(['middleware'=>['AuthCheck','AlreadyLogged','AdminCheck']], function(){
...
Route::get('availability/export/', [ScheduleController::class, 'export'])->name('avail.export')->middleware('AuthCheck', 'AdminCheck');

//User Route Group
Route::group(['middleware'=>['AuthCheck','AlreadyLogged','UserCheck']], function(){
