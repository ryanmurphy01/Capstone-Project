        ...
        <div class="row flex-nowrap">
            <div class="col-auto col-md-0 col-xl-0 px-sm-2 px-0">
                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-1 pt-2 min-vh-100"
                    ...
                    <a href="/"
                        class="d-flex align-items-center pb-3 mb-md-0 me-md-auto link-dark text-decoration-none justify-center">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu"
                        ...
                        <li class="nav-item" style="width: 100%">
                            {{-- link goes here --}}
                            <a href="availability" class="nav-link align-middle px-0 link-dark active">
                                {{-- extra width and height to compensate padding which makes it smaller, also margin and padding to make it centered in small version --}}
                                {{-- styles: style="padding-bottom: 5px; margin-left: 5px". make the image height and width 30 --}}
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                ...
                                {{-- font size bigger so you can actually see it --}}
                                <span class="ms-1 d-none d-sm-inline" style="font-size: 14pt;">Instructor
                                    Availability</span>
                            </a>
                        </li>
                        <li class="nav-item" style="width: 100%">
            ...
            <div class="col py-3">
                ...
                over a certain threshold and background colour = blue or something --}}
                                ...
                                <td>
                                            ...
                                            <ul style="list-style: none;">
                                                <div class="border border-1 border-dark m-1">
                                                    <div class="bg-info">
                                                        ...
                                                        <li>{{ \Carbon\Carbon::createFromFormat('H:i:s', $mondayTime->start_time)->format('h:i A') }}-{{ \Carbon\Carbon::createFromFormat('H:i:s', $mondayTime->end_time)->format('h:i A') }}
                                                        </li>
                                    ...
                                    @else
                                        <ul style="list-style: none;">
                                            <div class="bg-danger text-light m-1 border border-1 border-dark"
                                                style="height: 150px;">
                                            ...
                                            <ul style="list-style: none;">
                                                <div class="border border-1 border-dark m-1">
                                                    <div class="bg-info">
                                                        ...
                                                        <li>{{ \Carbon\Carbon::createFromFormat('H:i:s', $tuesdayTime->start_time)->format('h:i A') }}-{{ \Carbon\Carbon::createFromFormat('H:i:s', $tuesdayTime->end_time)->format('h:i A') }}
                                                        </li>
                                            ...
                                            <ul style="list-style: none;">
                                                <div class="border border-1 border-dark m-1">
                                                    <div class="bg-info">
                                                        ...
                                                        <li>{{ \Carbon\Carbon::createFromFormat('H:i:s', $wednesdayTime->start_time)->format('h:i A') }}-{{ \Carbon\Carbon::createFromFormat('H:i:s', $wednesdayTime->end_time)->format('h:i A') }}
                                                        </li>
                                        ...
                                        <ul style="list-style: none;">
                                            <div class="border border-1 border-dark m-1">
                                                <div class="bg-info">
                                                    ...
                                                    <li>{{ \Carbon\Carbon::createFromFormat('H:i:s', $thursdayTime->start_time)->format('h:i A') }}-{{ \Carbon\Carbon::createFromFormat('H:i:s', $thursdayTime->end_time)->format('h:i A') }}
                                                    </li>
                                        ...
                                        <ul style="list-style: none;">
                                            <div class="border border-1 border-dark m-1">
                                                <div class="bg-info">
                                                    ...
                                                    <li>{{ \Carbon\Carbon::createFromFormat('H:i:s', $fridayTime->start_time)->format('h:i A') }}-{{ \Carbon\Carbon::createFromFormat('H:i:s', $fridayTime->end_time)->format('h:i A') }}
                                                    </li>
                                        ...
                                        <ul style="list-style: none;">
                                            <div class="border border-1 border-dark m-1">
                                                <div class="bg-info">
                                                    ...
                                                    <li>{{ \Carbon\Carbon::createFromFormat('H:i:s', $saturdayTime->start_time)->format('h:i A') }}-{{ \Carbon\Carbon::createFromFormat('H:i:s', $saturdayTime->end_time)->format('h:i A') }}
                                                    </li>
